...
//label距離邊緣多遠
var labelPadding = 3;
var leftLabelPadding = labelPadding, rightLabelPadding = labelPadding, topLabelPadding = labelPadding, bottomLabelPadding = labelPadding;
...
function refleshGUI() {
    ...
    if (viewport.KO == true) getByid("OnlyShowKOImg").classList.add("activeImg");
    else getByid("OnlyShowKOImg").classList.remove("activeImg");
}
